...
function CampaignSectionLayout({ campaign, activeSection, eyebrow, title, description, count, headerAside, onBack, pageClassName = "", contentClassName = "", children }) {
  const backLabel = activeSection === "participants" ? "Minhas campanhas" : campaign.name;
  const aside = headerAside || (count !== undefined ? <span className="campaign-role campaign-role--player">{count} entradas</span> : null);
